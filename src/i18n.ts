  ...
  en: {
    translation: {
      ...
      privacy: {
        ...
        tp1Title: "Authentication (Supabase, Google, Apple, Facebook)",
        tp1Desc1: "We use Supabase for secure authentication. When you sign up with third-party providers (Google, Apple, or Facebook), we only receive your basic profile information (such as your name and email address) necessary to create your account.",
  ...
  "zh-TW": {
    translation: {
      ...
      privacy: {
        ...
        tp1Title: "登入驗證 (Supabase, Google, Apple, Facebook)",
        tp1Desc1: "我們靠 Supabase 把關你的登入安全。當你使用第三方服務（Google、Apple 或 Facebook）註冊時，我們只會收到建立帳號所需的基本個人資料（例如你的名字和 Email）。",
  ...
  "zh-CN": {
    translation: {
      ...
      privacy: {
        ...
        tp1Title: "登录验证 (Supabase, Google, Apple, Facebook)",
        tp1Desc1: "我们靠 Supabase 把关你的登录安全。当你使用第三方服务（Google、Apple 或 Facebook）注册时，我们只会收到创建账号所需的基本个人资料（例如你的名字和 Email）。",
  ...
  "ja": {
    translation: {
      ...
      privacy: {
        ...
        tp1Title: "認証 (Supabase, Google, Apple, Facebook)",
        tp1Desc1: "安全な認証のためにSupabaseを使用しています。サードパーティプロバイダー（Google、Apple、またはFacebook）で登録する場合、アカウントの作成に必要な基本的なプロフィール情報（名前やメールアドレスなど）のみを受け取ります。",
