  ...
  en: {
    translation: {
      ...
      features: {
        ...
        f1Desc: "Share a link from Instagram, TikTok, or anywhere else. Pocklet saves it in seconds.",
      ...
      privacy: {
        ...
        intro1: "Pocklet is built around a simple principle: your data stays yours.",
        ...
        collect4Desc2: "Location data is stored locally and never sent to Pocklet's servers.",
        ...
        deletionDesc2: "To delete your account, open the Pocklet app, go to Settings > Account, and tap \"Delete Account\". This action is irreversible and will immediately remove your authentication credentials from our servers.",
        ...
        childrenDesc1: "Pocklet is available to users of all ages. If you're under 13 (or under the age of consent in your country), you should use Pocklet with parental guidance.",
        childrenDesc2: "Since all data is stored locally and we don't collect personal information beyond your email (if you create an account), Pocklet is safe for younger users when used responsibly.",
        ...
        updatesDesc1: "We may update this policy as Pocklet evolves.",
        ...
        questionsDesc1: "If you have questions about this privacy policy or how Pocklet handles your data, email us at:",
  ...
  "zh-TW": {
    translation: {
      ...
      features: {
        ...
        f1Title: "什麼 App 都能存",
        f1Desc: "把 Instagram、脆還是任何地方的連結分享過來。Pocklet 幾秒內幫你搞定。",
      ...
      privacy: {
        ...
        intro1: "Pocklet 的原則超簡單：你的資料，就是你的。",
        ...
        collect4Desc2: "這些位置資訊只會存在你手機裡，絕對不會傳到 Pocklet 的伺服器上。",
        collect5Title: "推播通知",
        ...
        deletionDesc2: "若要刪除帳號，請打開 Pocklet App，前往「設定」>「帳號」，然後點擊「刪除帳號」。此操作無法復原，並會立即從我們的伺服器中移除您的登入憑證。",
        deletionDesc3: "請注意，由於您的收藏內容是儲存在您的裝置本地，刪除帳號並不會自動刪除裝置上的資料。若要移除所有本地資料，您必須從裝置上刪除此 App。",
        childrenTitle: "關於小朋友的隱私",
        childrenDesc1: "Pocklet 誰都能用！但如果你還未滿 13 歲（或是你國家規定的年齡），記得要找爸媽陪你一起用喔。",
  ...
  "zh-CN": {
    translation: {
      ...
      features: {
        ...
        f1Title: "万物皆可存",
        f1Desc: "把小红书、抖音还是任何地方的链接分享过来。Pocklet 几秒内帮你搞定。",
      ...
      privacy: {
        ...
        intro1: "Pocklet 的原则超简单：你的数据，就是你的。",
        ...
        collect4Desc2: "这些位置信息只会存在你手机里，绝对不会传到 Pocklet 的服务器上。",
        collect5Title: "推送通知",
        ...
        deletionDesc2: "若要删除账号，请打开 Pocklet App，前往“设置”>“账号”，然后点击“删除账号”。此操作无法恢复，并会立即从我们的服务器中移除您的登录凭证。",
        deletionDesc3: "请注意，由于您的收藏内容是存储在您的设备本地，删除账号并不会自动删除设备上的数据。若要移除所有本地数据，您必须从设备上删除此 App。",
        childrenTitle: "关于小朋友的隐私",
        childrenDesc1: "Pocklet 谁都能用！但如果你还未满 13 岁（或是你国家规定的年龄），记得要找爸妈陪你一起用哦。",
