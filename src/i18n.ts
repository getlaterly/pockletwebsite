  ...
  "zh-TW": {
    translation: {
      ...
      privacy: {
        ...
        collect3Desc1: "當你丟連結進來時，我們會透過第三方小幫手（noembed.com 還有我們自己的 Supabase 程式）去抓預覽圖跟標題。",
        collect3Desc2: "這些動作都是從你手機直接發出的，我們不會偷看也不會記錄你到底存了哪些網站。",
        collect4Title: "位置資訊",
        ...
        tp1Title: "登入驗證 (Supabase)",
        tp1Desc1: "我們靠 Supabase 把關你的登入安全。不管你是用 Email、Google、Apple 還是 Facebook 註冊，Supabase 都會安全地收好你的憑證。",
        tp1Desc2Prefix: "想了解更多可以看看 Supabase 的",
        tp1Desc2Link: "隱私權政策",
        tp1Desc2Suffix: "。",
        tp2Title: "連結預覽 (noembed)",
        tp2Desc1: "幫你抓網頁預覽圖和標題時，我們用到了 noembed.com 和直接抓取網頁內容的技術。",
        tp2Desc2: "這些請求會從我們安全的 Supabase 伺服器發出去。Noembed 可能會留存你抓取的網址紀錄，但我們沒辦法控制他們怎麼處理資料。",
  ...
  "zh-CN": {
    translation: {
      ...
      privacy: {
        ...
        collect3Desc1: "当你丢链接进来时，我们会通过第三方小助手（noembed.com 还有我们自己的 Supabase 程序）去抓预览图和标题。",
        collect3Desc2: "这些动作都是从你手机直接发出的，我们不会偷看也不会记录你到底存了哪些网站。",
        collect4Title: "位置信息",
        ...
        tp1Title: "登录验证 (Supabase)",
        tp1Desc1: "我们靠 Supabase 把关你的登录安全。不管你是用 Email、Google、Apple 还是 Facebook 注册，Supabase 都会安全地收好你的凭证。",
        tp1Desc2Prefix: "想了解更多可以看看 Supabase 的",
        tp1Desc2Link: "隐私政策",
        tp1Desc2Suffix: "。",
        tp2Title: "链接预览 (noembed)",
        tp2Desc1: "帮你抓网页预览图和标题时，我们用到了 noembed.com 和直接抓取网页内容的技术。",
        tp2Desc2: "这些请求会从我们安全的 Supabase 服务器发出去。Noembed 可能会留存你抓取的网址记录，但我们没办法控制他们怎么处理数据。",
